...
//
//Usage :
//		AtlLoadGdiplusImage( IDB_PNG101, _T("PNG") )
//
ATLINLINE HBITMAP AtlLoadGdiplusImage(ATL::_U_STRINGorID bitmap, ATL::_U_STRINGorID type = (UINT) 0)
{
   ...
   else 
   {
	  ...
	  pBitmap = new Gdiplus::Bitmap(AtlGetAppModule().GetResourceInstance(), (LPCWSTR) (UINT) bitmap.m_lpstr);	   
   }
...
//////////////////////////////////////////////////////////////////////////
// 
ATLINLINE HBITMAP AtlLoadPngImage(ATL::_U_STRINGorID bitmap)
{
	return ::AtlLoadGdiplusImage(bitmap,_T("PNG"));
}
